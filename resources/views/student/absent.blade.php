                ...
                <tbody>
                  ...
                  <td>{{$s->student_no}}</td>
                    ...
                    <td>
                      ...
                      data-contact="{{$s->mobile_no}}" data-addresss="{{$s->address}}" data-addresss="{{$s->address}}">View</a>
                      <a href="#" data-toggle="modal" data-target="#admissionView" class="btn btn-outline-info btn-sm" data-id="{{$s->student_no}}" data-fname="{{$s->fname}}"data-lname="{{$s->lname}}" data-section="{{$s->class}}"
                          data-contact="{{$s->mobile_no}}" data-addresss="{{$s->address}}" data-addresss="{{$s->address}}">Admission</a> --}}
                          <!-- MODAL -->
